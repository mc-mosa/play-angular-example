...
public class routes {
  ...
  public static final controllers.ReverseDataController DataController = new controllers.ReverseDataController(RoutesPrefix.byNamePrefix());
  ...
  public static class javascript {
    ...
    public static final controllers.javascript.ReverseDataController DataController = new controllers.javascript.ReverseDataController(RoutesPrefix.byNamePrefix());
